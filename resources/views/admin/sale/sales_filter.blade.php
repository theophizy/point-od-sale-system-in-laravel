                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <form action="{{route('sales_view')}}" method="GET">
                            ...
                            <table id="salesResults" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button id="detailsBtn" class="btn btn-primary details-btn" data-sale-id="{{$sale->id}}" title="View Invoice Details"><i class="typcn typcn-eye menu-icon"></i></button>
