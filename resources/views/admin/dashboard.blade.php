          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="media">
                      <i class="typcn typcn-user icon-md text-primary d-flex align-self-start mr-2"></i>
                      <div class="media-body">
                        <h3 class="card-text text-primary "><strong>{{$totalUsers}}</strong></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h4 class="card-title">Total {{$selectedPaymentMethod}} Sales from inception</h4>
                    @elseif($daysSelected && $selectedPaymentMethod)
                    <h4 class="card-title">Total {{$selectedPaymentMethod}} Sales in the last {{$daysSelected}} days</h4>
                    @else
                    <h4 class="card-title">Total sales from inception</h4>
                    @endif
                    <div class="media">
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> Total System Roles</h4>
                    <div class="media">
                      <i class="typcn typcn-key icon-md text-primary d-flex align-self-start mr-2"></i>
                      <div class="media-body">
                        <h3 class="card-text text-primary "><strong>{{$totalRoles}}</strong></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="media">
                      <i class="typcn typcn-database icon-md text-primary d-flex align-self-start mr-2"></i>
                      <div class="media-body">
                        <h3 class="card-text text-primary "><strong>{{number_format(($totalAmountSales-$totalExpendituresOnProductPurchased),2)}}</strong></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  @if( $daysSelected )
                    <h4 class="card-title">Total Purchase of Products in the last {{$daysSelected}} days</h4>
              
                    @else
                    <h4 class="card-title">Total Purchase of Products From Inception</h4>
                    @endif
                   
                    <div class="media">
                      <i class="typcn typcn-briefcase icon-md text-primary d-flex align-self-start mr-2"></i>
                      <div class="media-body">
                        <h3 class="card-text text-primary "><strong>N{{number_format($totalExpendituresOnProductPurchased,2)}}</strong></h3>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    @if($daysSelected)
                    <h4 class="card-title">Last {{$daysSelected}} days sales Data </h4>
                    @elseif($selectedPaymentMethod)
                    <h4 class="card-title">Last month {{$selectedPaymentMethod}} sales Data </h4>

                    @elseif($daysSelected && $selectedPaymentMethod)
                    <h4 class="card-title">Last {{$daysSelected}} days {{$selectedPaymentMethod}} sales Data </h4>
                    @else
                    <h4 class="card-title">Last month sales Data </h4>
                    @endif
                    <div class="media">
